...
if (start1==true && start2 == false) {
  fill(255);
  rect(lineX2 + lineX1*1/3, lineY1*4/3, appWidth*1/9, appHeight*1/9);
...
if (start2==true && start3 == false) {
  fill(255);
  rect(lineX2 + lineX1*1/3, lineY2*+lineY1*1/9, appWidth*1/9, appHeight*1/9);
  ...
  fill(255);
  rect(lineX1 + lineX1*1/3, lineY2 + lineY1*1/9, appWidth*1/9, appHeight*1/9);
